...
export const fa: Dict = {
  ...
  projects: {
    ...
    items: {
      ...
      rubika:
        "فایل‌های تا ۲ گیگابایت را میان دو پلتفرم جابه‌جا می‌کند تا کاربران ایرانی پهنای باند محدود VPN را صرف آپلود دوبارهٔ چیزی که پیش‌تر فرستاده‌اند نکنند.",
      fastquora:
  ...
  about: {
    title: "درباره",
    paragraphs: [
      "مهندس نرم‌افزارم و ساکن تهران؛ پنج سال است با Python کار می‌کنم و بیشترش در بک‌اند بوده. مدتی است روی ویدیوی مبتنی بر هوش مصنوعی کار می‌کنم و همان‌جا فهمیدم مسئلهٔ جالب معمولاً خودِ مدل نیست، بلکه هر چیزی است که دورش ساخته می‌شود — صف‌هایی که مرگ یک کارگر را تاب می‌آورند، وضعیتی که بشود از سر گرفت، و پیشرفتی که کاربر واقعاً ببیندش.",
      ...
      "بیرون از کار متن‌باز منتشر می‌کنم — بیشتر بک‌اند، به‌علاوهٔ یک بستهٔ self-hosted برای همکاری روی شبکه‌هایی که نمی‌شود به آن‌ها تکیه کرد؛ مسئله‌ای که اینجا کاملاً واقعی است. در Medium هم می‌نویسم که سامانه‌های مبتنی بر مدل‌های زبانی، وقتی کاربر واقعی به آن‌ها می‌رسد، دقیقاً چه می‌کنند.",
    ],
    facts: {
      based: { label: "ساکن", value: "تهران، ایران" },
  ...
  footer: {
    built: "طراحی و ساخته‌شده در تهران",
    source: "کد منبع",
